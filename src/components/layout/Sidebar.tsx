    ...
    <>
      ...
      <div className="mb-8 px-3 pt-2">
        <Link href="/" className="flex items-center justify-center xl:justify-start">
          ...
          {/* Camera Icon - LG screens (not XL) */}
          <svg className="xl:hidden w-8 h-8 text-[#262626] dark:text-white" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
