...
export default function ProfileHeader({
  ...
  return (
    <>
      <header className="px-4 py-4 md:py-6 max-[639px]:px-2">
      <div className="max-w-[693px] mx-auto">
        <div className="flex flex-col md:flex-row gap-6 md:gap-7 items-center">
          {/* Profile Picture */}
          <div className="flex justify-center md:justify-start flex-shrink-0">
            <div
              className={`relative w-[77px] h-[77px] md:w-[150px] md:h-[150px] cursor-pointer transition-transform duration-150 ${isBumping ? 'scale-95' : ''} max-[639px]:w-[70px] max-[639px]:h-[70px]`}
          ...
          <div className="flex-1 min-w-0">
            {/* Username + Badge Row */}
            <div className="flex items-center gap-1.5 mb-5 max-[639px]:mb-3">
              <h1
                className="text-2xl font-bold leading-[30px] h-[30px] truncate cursor-pointer text-instagram-primary max-[639px]:text-xl"
                tabIndex={0}
              >
                {profile.username}
              </h1>
